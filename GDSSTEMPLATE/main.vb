Public Class main
    ...
    Private Sub main_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'GdssDataSet1.PersonAndGun' table. You can move, or remove it, as needed.
        Me.PersonAndGunTableAdapter.Fill(Me.GdssDataSet1.PersonAndGun)
